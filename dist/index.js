...
(() => {
  ...
  function typeHero() {
    ...
    const reversedText = originalText.split(/([,\s]+)/).reverse().join("");
    const options = {
  ...
  // src/home/homeHero.ts
  function heroAnim() {
    const heroElement = document.querySelector(".scrolling-hero_frame-w");
    const navbarElement = document.querySelector(".section_navbar#navbar-home");
    if (!heroElement || !navbarElement)
      return;
